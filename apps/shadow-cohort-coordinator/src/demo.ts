...
console.log('\nTEAM FEASIBILITY');
console.log(`Estimated work: ${result.feasibility.totalEstimatedProjectHours}h`);
console.log(`Safe team capacity: ${result.feasibility.totalSafeTeamHours}h`);
console.log(`Capacity margin: ${result.feasibility.capacityMargin}h`);
console.log(`Status: ${result.feasibility.status.toUpperCase()}`);
console.log('\nA2A EVENT LOG');
...
console.log(`Privacy: ${privateMarkers.some((marker) => serialized.includes(marker)) ? 'FAIL' : 'PASS'}`);
